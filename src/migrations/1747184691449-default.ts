...
export class Default1747184691449 implements MigrationInterface {
    name = 'Default1747184691449'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "tb_usuario" ("id" int NOT NULL IDENTITY(1,1), "nm_usu" text NOT NULL, "email_usu" nvarchar(255) NOT NULL, "senha_usu" text NOT NULL, "createdAt" datetime2 NOT NULL CONSTRAINT "DF_e8fb2d73b2e2a11723ed9ce8700" DEFAULT getdate(), "updatedAt" datetime2 NOT NULL CONSTRAINT "DF_1f890252dc88de08fe9f7adad0c" DEFAULT getdate(), "status_id" int, CONSTRAINT "UQ_ddf0cf98fc011f0b481038aef61" UNIQUE ("email_usu"), CONSTRAINT "PK_fea85fa13fe26913a53d66a44db" PRIMARY KEY ("id"))`);
